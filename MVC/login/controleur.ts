...
class Controleur implements IControleur {
    ...
    private co: IConnexion;
            ...
            {
                if (mdp != mdp2) {
                    this.vue.Erreur("Les mots de passe doivent �tre identique");
                }else if (mdp =="") {
                    this.vue.Erreur("Le mot de passe ne doit pas �tre vide");
                } else if (lg == "") {
                    this.vue.Erreur("L'identifiant ne doit pas �tre vide")
                }else {
                    ...
                    if (ins.estInscrit()) {
                        ...
                        this.vue.Erreur("L'indentifiant existe d�j� ou une erreur inconnu s'est produite");
                    }
